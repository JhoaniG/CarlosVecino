    ...
    <body>
        ...
        <div class="container section">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="ClienteController?menu=Clientes&accion=Agregar" class="btn btn-success"><i class="fas fa-plus"></i> Registrar Cliente</a>
            </div>
                    ...
                    <tbody>
                        <c:forEach var="u" items="${lista_clientes}">
                            <tr>
                                ...
                                <td>
                                    <a href="ClienteController?menu=Clientes&accion=Editar&documento=${u.getDocumento()}" class="btn btn-warning btn-sm">
                                        <i class="fas fa-edit"></i> Editar
                                    </a>
                                    <a href="ClienteController?menu=Clientes&accion=Eliminar&documento=${u.getDocumento()}" 
        ...
        <%
            ...
            if ("con_creditos".equals(error)) {
        %>
        <div class="alert alert-warning" role="alert">
            ⚠ No se puede eliminar este cliente porque tiene créditos registrados.
        </div>
        <%
            }
        %>
